...
def convert_one_case(args):
    ...
    output_image_mha_path = os.path.join(series_output_folder, f"{series_id}_image.mha")
    output_label_mha_path = os.path.join(series_output_folder, f"{series_id}_label.mha")
